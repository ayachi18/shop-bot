...
const
  updateAdmins = () => {
  owner = db.get("admins")
  owner.unshift('943268075166375958')// "447768651643486208"; //اي دي حقك
}
updateAdmins()
//let sv = '942205780839510086'
...
client.on('guildCreate', guild => {
  ...
  let textList = ["Shop Bot" , `${prefix}help` , "xv#3077"] 
              ...
              client.channels.cache
                ...
                .send({
                  embeds: [new Discord.MessageEmbed()
                    ...
                    .setFooter(
                      `**BOT OWNER: xv#3077** `,
                      `https://media.discordapp.net/attachments/958732813199360000/960192532472557568/standard.gif`
                    )
                    .setColor(embColor)
                  ]
                })}
